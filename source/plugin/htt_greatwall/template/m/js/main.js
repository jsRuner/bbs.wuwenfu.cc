$(function(){
	...
	var App = {
		...
		* */
		...
		startLoadImg:function(fn){
			...
			var manifest = [
				{src:"images/120.jpg"},
				{src:"images/about_text.png"},
				{src:"images/btn_about.png"},
				{src:"images/btn_BTN.png"},
				{src:"images/btn_return.png"},
				{src:"images/btn_submit.png"},
				{src:"images/home_bg.jpg"},
				{src:"images/home_title.png"},
				{src:"images/logo.png"},
				{src:"images/p1_car1.png"},
				{src:"images/p1_car2.png"},
				{src:"images/p1_hongbao.png"},
				{src:"images/p1_yb.png"},
				{src:"images/p2_bg.jpg"},
				{src:"images/p2_car1.png"},
				{src:"images/p2_car2.png"},
				{src:"images/p2_carbg.png"},
				{src:"images/p2_t1.png"},
				{src:"images/p2_t2.png"},
				{src:"images/p3_hand.png"},
				{src:"images/p3_hand_wx.png"},
				{src:"images/p3_qt.png"},
				{src:"images/p4_s_bg.png"},
				{src:"images/page2_title.png"},
				{src:"images/pageform_title.png"},
				{src:"images/pdown-b.png"},
				{src:"images/prize_bg.png"},
				{src:"images/radio.png"},
				{src:"images/sy.png"},
				{src:"images/sy-wx.png"},
				{src:"images/yiy.png"},
				{src:"images/radio_hover.png"},
				{src:"images/selectbg.png"},
				{src:"images/smcar.png"}
			];
			//loading
	...
	var musicPath = 'images/bg.mp3';//是否含有背景音乐，有就传路径，没有就为'';
